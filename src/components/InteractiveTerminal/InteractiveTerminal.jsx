...
export default function InteractiveTerminal({ isEmbedded = false, onOpenArch, onClose }) {
      ...
      switch (root) {
        ...
        case "projects":
          newEntries.push(
            ...
            { type: "accent", text: "1. ApplyPilot AI — Autonomous Job Application Engine & Copilot" },
            { type: "output", text: "   Manifest V3 -> Multi-Signal DOM Heuristics -> React/Vue Synthetic Dispatcher -> Async Gemini Loop" },
            { type: "muted", text: "   Try: 'arch applypilot-ai' to inspect the autonomous engine blueprint." },
            { type: "accent", text: "2. SplitHive — Distributed Real-Time Expense Ledger" },
            ...
            { type: "accent", text: "3. Distributed AI Real-Time Transcription Pipeline" },
            ...
            { type: "accent", text: "4. High-Throughput Network Inspector & Diagnostic Engine" },
            ...
            { type: "accent", text: "5. Uber High-Scale Dispatch & Fleet Telemetry" },
  ...
  const chips = ["help", "bio", "skills", "projects", "arch applypilot-ai", "arch splithive", "arch ai-transcription", "sudo hire"];
